...
exports.CARD = 'card';
exports.REQUEST_CARDS = 'request cards';
exports.RECEIVE_CARDS = 'receive cards';
exports.TOGGLE_CARD_DETAILS = 'toggle card details';
exports.REQUEST_CREATE_CARD = 'request create card';
exports.RECEIVE_CREATE_CARD = 'receive create card';
exports.REQUEST_UPDATE_CARD = 'request update card';
exports.RECEIVE_UPDATE_CARD = 'receive update card';
exports.UPDATE_CARD_STATUS = 'update card status';
exports.UPDATE_CARD_POSITION = 'update card position';
exports.REQUEST_PERSIST_CARD_DRAG = 'request persist card drag';
exports.RECEIVE_PERSIST_CARD_DRAG = 'receive persist card drag';
exports.CREATE_DRAFT = 'create draft';
exports.UPDATE_DRAFT = 'update draft';
exports.REQUEST_CREATE_TASK = 'request create task';
exports.RECEIVE_CREATE_TASK = 'receive create task';
exports.REQUEST_DELETE_TASK = 'request delete task';
exports.RECEIVE_DELETE_TASK = 'receive delete task';
exports.REQUEST_TOGGLE_TASK = 'request toggle task';
exports.RECEIVE_TOGGLE_TASK = 'receive toggle task';
...
const redux_thunk_1 = __webpack_require__(25);
const react_redux_1 = __webpack_require__(2);
const redux_1 = __webpack_require__(7);
const KanbanBoardComponent_1 = __webpack_require__(64);
const rootReducer_1 = __webpack_require__(73);
...
const kanbanStore = redux_1.createStore(rootReducer_1.default, redux_1.applyMiddleware(logger, redux_thunk_1.default));
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: kanbanStore },
    React.createElement(KanbanBoardComponent_1.default, null)), document.getElementById("root"));
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(2);
const KanbanBoardView_1 = __webpack_require__(65);
const CardsActionCreators_1 = __webpack_require__(72);
const mapStateToProps = (state) => ({ cards: state.cards });
const mapDispatchToProps = (dispatch) => ({
    fetchCards: () => (dispatch(CardsActionCreators_1.CardsActionCreators.fetchCards()))
});
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(KanbanBoardView_1.KanbanBoard);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const ICard_1 = __webpack_require__(66);
const ListView_1 = __webpack_require__(67);
class KanbanBoard extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "app" },
            React.createElement(ListView_1.default, { key: "todo", title: "To Do", cards: this.props.cards.filter((card) => card.status === ICard_1.StatusTypes.ToDo) }),
            React.createElement(ListView_1.default, { key: "in-progress", title: "In Progress", cards: this.props.cards.filter((card) => card.status === ICard_1.StatusTypes.InProgress) }),
            React.createElement(ListView_1.default, { key: "done", title: "Done", cards: this.props.cards.filter((card) => card.status === ICard_1.StatusTypes.Done) })));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const CardView_1 = __webpack_require__(68);
const List = (props) => {
    let cards = props.cards.map((card) => {
        return React.createElement(CardView_1.Card, { card: card, key: card.id });
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const CheckListComponent_1 = __webpack_require__(69);
exports.Card = (props) => {
    return (React.createElement("div", { className: "card" },
        React.createElement("div", { className: "card__title" }, props.card.title),
        React.createElement("div", { className: "card__details" },
            props.card.description,
            React.createElement(CheckListComponent_1.default, { tasks: props.card.tasks, cardId: props.card.id }))));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(2);
const CheckListView_1 = __webpack_require__(70);
const TaskActionCreators_1 = __webpack_require__(71);
const mapStateToProps = (state) => ({});
const mapDispatchToProps = (dispatch) => ({
    addTask: (cartId, newTask) => (dispatch(TaskActionCreators_1.TaskActionCreators.AddTask(cartId, newTask))),
    deleteTask: (cartId, deletedTask) => (dispatch(TaskActionCreators_1.TaskActionCreators.DeleteTask(cartId, deletedTask))),
    toggleTask: (cartId, changedTask) => (dispatch(TaskActionCreators_1.TaskActionCreators.ToggleTask(cartId, changedTask)))
});
exports.default = react_redux_1.connect(null, mapDispatchToProps)(CheckListView_1.CheckList);
...
class CheckList extends React.Component {
    ...
    render() {
        let tasks = this.props.tasks.map((task) => React.createElement("li", { key: task.id, className: "checklist__task" },
            React.createElement("input", { type: "checkbox", checked: task.done, onChange: this.props.toggleTask.bind(null, this.props.cardId, task) }),
            task.name,
            React.createElement("a", { href: "#", onClick: this.props.deleteTask.bind(null, this.props.cardId, task), className: "checklist__task--remove" })));
        return (React.createElement("div", { className: "checklist" },
            React.createElement("ul", null, tasks),
            React.createElement("input", { type: "text", className: "checklist--add-task", placeholder: "Type then hit Enter to add a task", onKeyPress: this.checkInputKeyPress.bind(this) })));
    }
}
...
const KanbanAPI_1 = __webpack_require__(22);
/*
export interface ITaskIndexAction extends ITaskAction{
    taskIndex:number
}
*/
class TaskActionCreators {
    static _sendError(type, error) {
        return { type: type, error: error, success: false };
    }
    static _AddRequestTask(cartId, task) {
        return { type: constants_1.REQUEST_CREATE_TASK };
    }
    static _AddRecieveTask(cartId, task) {
        return { type: constants_1.RECEIVE_CREATE_TASK, task: task, cartId: cartId, success: true };
    }
    static AddTask(cartId, task) {
        return (dispatch) => __awaiter(this, void 0, void 0, function* () {
            try {
                this._AddRequestTask(cartId, task);
                let new_task = yield KanbanAPI_1.default.addTask(cartId, task);
                dispatch(this._AddRecieveTask(cartId, new_task));
            }
            catch (error) {
                dispatch(this._sendError(constants_1.RECEIVE_CREATE_TASK, error));
            }
        });
    }
    static _DeleteRequestTask(cartId, task) {
        return { type: constants_1.REQUEST_DELETE_TASK };
    }
    static _DeleteRecieveTask(cartId, task) {
        return { type: constants_1.RECEIVE_DELETE_TASK, task: task, cartId: cartId, success: true };
    }
    static DeleteTask(cartId, task) {
        return (dispatch) => __awaiter(this, void 0, void 0, function* () {
            try {
                this._DeleteRequestTask(cartId, task);
                yield KanbanAPI_1.default.deleteTask(cartId, task);
                dispatch(this._DeleteRecieveTask(cartId, task));
            }
            catch (error) {
                dispatch(this._sendError(constants_1.RECEIVE_DELETE_TASK, error));
            }
        });
    }
    static _ToggleRequestTask(cartId, task) {
        return { type: constants_1.REQUEST_TOGGLE_TASK };
    }
    static _ToggleRecieveTask(cartId, task) {
        return { type: constants_1.RECEIVE_TOGGLE_TASK, task: task, cartId: cartId, success: true };
    }
    static ToggleTask(cartId, task) {
        return (dispatch) => __awaiter(this, void 0, void 0, function* () {
            try {
                this._ToggleRequestTask(cartId, task);
                yield KanbanAPI_1.default.toogleTask(cartId, task);
                dispatch(this._ToggleRecieveTask(cartId, task));
            }
            catch (error) {
                dispatch(this._sendError(constants_1.RECEIVE_TOGGLE_TASK, error));
            }
        });
    }
}
exports.TaskActionCreators = TaskActionCreators;
...
const constants_1 = __webpack_require__(9);
const KanbanAPI_1 = __webpack_require__(22);
class CardsActionCreators {
    static _requestCards() {
        return { type: constants_1.REQUEST_CARDS };
    }
    static _recieveCards(cards) {
        return { cards: cards, type: constants_1.RECEIVE_CARDS, success: true };
    }
    static _sendError(type, error) {
        return { type: type, error: error, success: false };
    }
    static fetchCards() {
        return (dispatch) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let cards = yield KanbanAPI_1.default.fetchCards();
                dispatch(this._recieveCards(cards));
            }
            catch (error) {
                dispatch(this._sendError(constants_1.RECEIVE_CARDS, error));
            }
        });
    }
}
exports.CardsActionCreators = CardsActionCreators;
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(7);
const cardsReducer_1 = __webpack_require__(74);
const rootReducer = redux_1.combineReducers({
    cards: cardsReducer_1.cardsReducer
});
...
Object.defineProperty(exports, "__esModule", { value: true });
const constants_1 = __webpack_require__(9);
const utilites_1 = __webpack_require__(75);
exports.cardsReducer = (state = [], action) => {
    //let newTask:ITask;
    //let cardIndex:number;
    //let taskIndex:number;
    switch (action.type) {
        case constants_1.RECEIVE_CARDS:
            return utilites_1.DeepCopy(action).cards;
        ...
        case constants_1.RECEIVE_DELETE_TASK:
            if (action.success) {
                let deletedTaskId = (action).task.id;
                let cardId = action.cartId;
                let cardIndex = state.indexOf(state.filter(p => p.id === cardId)[0]);
        ...
        case constants_1.RECEIVE_TOGGLE_TASK:
            if (action.success) {
                let changedTaskId = (action).task.id;
                let cardId = action.cartId;
                let cardIndex = state.indexOf(state.filter(p => p.id === cardId)[0]);
